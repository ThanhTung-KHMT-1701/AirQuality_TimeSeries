...
def train_classifier(
    ...
    metrics = {
        ...
        "f1_macro": float(f1_score(y_test.loc[test_mask], y_pred, average="macro", zero_division=0)),
        "report": classification_report(y_test.loc[test_mask], y_pred, output_dict=True, zero_division=0),
